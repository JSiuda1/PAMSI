...
long __stdcall WindowProcess(HWND window, UINT message, WPARAM wideParameter, LPARAM longParameter){
	...
	case WM_SIZE: //resize window
		...
		return 0;
	case WM_SYSCOMMAND: //disable ALT aplication menu
		if ((wideParameter && 0xfff0) == SC_KEYMENU) {
			return 0;
		}
		break;

	case WM_DESTROY: //delete quit message
		PostQuitMessage(0);
		return 0;
	...
	case WM_MOUSEMOVE:
		if (wideParameter == MK_LBUTTON) { //if 
...
void gui::DestroyMHWindow() noexcept {
